...
2. You will find the example project in the path: community-code-examples/sensor_interfacing/cce-psoc6-tle4966k
...
7. Point to the project directory and click Select Folder. Select the checkbox next to __cce-psoc6-tle4966k__ application and click Create.
