...
#define CY_CAPSENSE_RESOLUTIONX_VALUE                                            (cy_capsense_tuner.gestureConfig[0].resolutionX)
#define CY_CAPSENSE_RESOLUTIONX_OFFSET                                           (262u)
#define CY_CAPSENSE_RESOLUTIONX_SIZE                                             (2u)
#define CY_CAPSENSE_RESOLUTIONX_PARAM_ID                                         (0x02000106u)

#define CY_CAPSENSE_RESOLUTIONY_VALUE                                            (cy_capsense_tuner.gestureConfig[0].resolutionY)
#define CY_CAPSENSE_RESOLUTIONY_OFFSET                                           (264u)
#define CY_CAPSENSE_RESOLUTIONY_SIZE                                             (2u)
#define CY_CAPSENSE_RESOLUTIONY_PARAM_ID                                         (0x02000108u)

#define CY_CAPSENSE_GESTUREENABLEMASK_VALUE                                      (cy_capsense_tuner.gestureConfig[0].gestureEnableMask)
#define CY_CAPSENSE_GESTUREENABLEMASK_OFFSET                                     (266u)
#define CY_CAPSENSE_GESTUREENABLEMASK_SIZE                                       (2u)
#define CY_CAPSENSE_GESTUREENABLEMASK_PARAM_ID                                   (0x0200010au)

#define CY_CAPSENSE_FLICK_TIMEOUT_MAX_VALUE                                      (cy_capsense_tuner.gestureConfig[0].flickTimeoutMax)
#define CY_CAPSENSE_FLICK_TIMEOUT_MAX_OFFSET                                     (268u)
#define CY_CAPSENSE_FLICK_TIMEOUT_MAX_SIZE                                       (2u)
#define CY_CAPSENSE_FLICK_TIMEOUT_MAX_PARAM_ID                                   (0x0200010cu)

#define CY_CAPSENSE_EDGE_TIMEOUT_MAX_VALUE                                       (cy_capsense_tuner.gestureConfig[0].edgeTimeoutMax)
#define CY_CAPSENSE_EDGE_TIMEOUT_MAX_OFFSET                                      (270u)
#define CY_CAPSENSE_EDGE_TIMEOUT_MAX_SIZE                                        (2u)
#define CY_CAPSENSE_EDGE_TIMEOUT_MAX_PARAM_ID                                    (0x0200010eu)

#define CY_CAPSENSE_CLICK_TIMEOUT_MAX_VALUE                                      (cy_capsense_tuner.gestureConfig[0].clickTimeoutMax)
#define CY_CAPSENSE_CLICK_TIMEOUT_MAX_OFFSET                                     (272u)
#define CY_CAPSENSE_CLICK_TIMEOUT_MAX_SIZE                                       (2u)
#define CY_CAPSENSE_CLICK_TIMEOUT_MAX_PARAM_ID                                   (0x02000110u)

#define CY_CAPSENSE_CLICK_TIMEOUT_MIN_VALUE                                      (cy_capsense_tuner.gestureConfig[0].clickTimeoutMin)
#define CY_CAPSENSE_CLICK_TIMEOUT_MIN_OFFSET                                     (274u)
#define CY_CAPSENSE_CLICK_TIMEOUT_MIN_SIZE                                       (2u)
#define CY_CAPSENSE_CLICK_TIMEOUT_MIN_PARAM_ID                                   (0x02000112u)

#define CY_CAPSENSE_SECOND_CLICK_INTERVAL_MAX_VALUE                              (cy_capsense_tuner.gestureConfig[0].secondClickIntervalMax)
#define CY_CAPSENSE_SECOND_CLICK_INTERVAL_MAX_OFFSET                             (276u)
#define CY_CAPSENSE_SECOND_CLICK_INTERVAL_MAX_SIZE                               (2u)
#define CY_CAPSENSE_SECOND_CLICK_INTERVAL_MAX_PARAM_ID                           (0x02000114u)

#define CY_CAPSENSE_SECOND_CLICK_INTERVAL_MIN_VALUE                              (cy_capsense_tuner.gestureConfig[0].secondClickIntervalMin)
#define CY_CAPSENSE_SECOND_CLICK_INTERVAL_MIN_OFFSET                             (278u)
#define CY_CAPSENSE_SECOND_CLICK_INTERVAL_MIN_SIZE                               (2u)
#define CY_CAPSENSE_SECOND_CLICK_INTERVAL_MIN_PARAM_ID                           (0x02000116u)

#define CY_CAPSENSE_ZOOM_DISTANCE_MIN_VALUE                                      (cy_capsense_tuner.gestureConfig[0].zoomDistanceMin)
#define CY_CAPSENSE_ZOOM_DISTANCE_MIN_OFFSET                                     (280u)
#define CY_CAPSENSE_ZOOM_DISTANCE_MIN_SIZE                                       (2u)
#define CY_CAPSENSE_ZOOM_DISTANCE_MIN_PARAM_ID                                   (0x02000118u)

#define CY_CAPSENSE_FLICK_DISTANCE_MIN_VALUE                                     (cy_capsense_tuner.gestureConfig[0].flickDistanceMin)
#define CY_CAPSENSE_FLICK_DISTANCE_MIN_OFFSET                                    (282u)
#define CY_CAPSENSE_FLICK_DISTANCE_MIN_SIZE                                      (2u)
#define CY_CAPSENSE_FLICK_DISTANCE_MIN_PARAM_ID                                  (0x0200011au)

#define CY_CAPSENSE_SCROLL_DISTANCE_MIN_VALUE                                    (cy_capsense_tuner.gestureConfig[0].scrollDistanceMin)
#define CY_CAPSENSE_SCROLL_DISTANCE_MIN_OFFSET                                   (284u)
#define CY_CAPSENSE_SCROLL_DISTANCE_MIN_SIZE                                     (2u)
#define CY_CAPSENSE_SCROLL_DISTANCE_MIN_PARAM_ID                                 (0x0200011cu)

#define CY_CAPSENSE_ROTATE_DISTANCE_MIN_VALUE                                    (cy_capsense_tuner.gestureConfig[0].rotateDistanceMin)
#define CY_CAPSENSE_ROTATE_DISTANCE_MIN_OFFSET                                   (286u)
#define CY_CAPSENSE_ROTATE_DISTANCE_MIN_SIZE                                     (2u)
#define CY_CAPSENSE_ROTATE_DISTANCE_MIN_PARAM_ID                                 (0x0200011eu)

#define CY_CAPSENSE_EDGE_DISTANCE_MIN_VALUE                                      (cy_capsense_tuner.gestureConfig[0].edgeDistanceMin)
#define CY_CAPSENSE_EDGE_DISTANCE_MIN_OFFSET                                     (288u)
#define CY_CAPSENSE_EDGE_DISTANCE_MIN_SIZE                                       (2u)
#define CY_CAPSENSE_EDGE_DISTANCE_MIN_PARAM_ID                                   (0x02000120u)

#define CY_CAPSENSE_SECOND_CLICK_DISTANCE_MAX_VALUE                              (cy_capsense_tuner.gestureConfig[0].secondClickDistanceMax)
#define CY_CAPSENSE_SECOND_CLICK_DISTANCE_MAX_OFFSET                             (290u)
#define CY_CAPSENSE_SECOND_CLICK_DISTANCE_MAX_SIZE                               (1u)
#define CY_CAPSENSE_SECOND_CLICK_DISTANCE_MAX_PARAM_ID                           (0x01000122u)

#define CY_CAPSENSE_CLICK_DISTANCE_MAX_VALUE                                     (cy_capsense_tuner.gestureConfig[0].clickDistanceMax)
#define CY_CAPSENSE_CLICK_DISTANCE_MAX_OFFSET                                    (291u)
#define CY_CAPSENSE_CLICK_DISTANCE_MAX_SIZE                                      (1u)
#define CY_CAPSENSE_CLICK_DISTANCE_MAX_PARAM_ID                                  (0x01000123u)

#define CY_CAPSENSE_ZOOM_DEBOUNCE_VALUE                                          (cy_capsense_tuner.gestureConfig[0].zoomDebounce)
#define CY_CAPSENSE_ZOOM_DEBOUNCE_OFFSET                                         (292u)
#define CY_CAPSENSE_ZOOM_DEBOUNCE_SIZE                                           (1u)
#define CY_CAPSENSE_ZOOM_DEBOUNCE_PARAM_ID                                       (0x01000124u)

#define CY_CAPSENSE_SCROLL_DEBOUNCE_VALUE                                        (cy_capsense_tuner.gestureConfig[0].scrollDebounce)
#define CY_CAPSENSE_SCROLL_DEBOUNCE_OFFSET                                       (293u)
#define CY_CAPSENSE_SCROLL_DEBOUNCE_SIZE                                         (1u)
#define CY_CAPSENSE_SCROLL_DEBOUNCE_PARAM_ID                                     (0x01000125u)

#define CY_CAPSENSE_ROTATE_DEBOUNCE_VALUE                                        (cy_capsense_tuner.gestureConfig[0].rotateDebounce)
#define CY_CAPSENSE_ROTATE_DEBOUNCE_OFFSET                                       (294u)
#define CY_CAPSENSE_ROTATE_DEBOUNCE_SIZE                                         (1u)
#define CY_CAPSENSE_ROTATE_DEBOUNCE_PARAM_ID                                     (0x01000126u)

#define CY_CAPSENSE_EDGE_ANGLE_MAX_VALUE                                         (cy_capsense_tuner.gestureConfig[0].edgeAngleMax)
#define CY_CAPSENSE_EDGE_ANGLE_MAX_OFFSET                                        (295u)
#define CY_CAPSENSE_EDGE_ANGLE_MAX_SIZE                                          (1u)
#define CY_CAPSENSE_EDGE_ANGLE_MAX_PARAM_ID                                      (0x01000127u)

#define CY_CAPSENSE_EDGE_EDGE_SIZE_VALUE                                         (cy_capsense_tuner.gestureConfig[0].edgeEdgeSize)
#define CY_CAPSENSE_EDGE_EDGE_SIZE_OFFSET                                        (296u)
#define CY_CAPSENSE_EDGE_EDGE_SIZE_SIZE                                          (1u)
#define CY_CAPSENSE_EDGE_EDGE_SIZE_PARAM_ID                                      (0x01000128u)
