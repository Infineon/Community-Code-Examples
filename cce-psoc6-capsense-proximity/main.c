...
* File Name: main.c
*
* Description: This code example features the CapSense proximty sensor. The 
*              proximity sensor controls the brightness of the LED. The example 
*              also features interfacing with Tuner GUI using I2C interface.
*
...
*  - scan proximity input continuously and update the LED accordingly.
*
* Return:
*  int
*
...
int main(void)
{
    ...
    for (;;)
    {
        if (CY_CAPSENSE_NOT_BUSY == Cy_CapSense_IsBusy(&cy_capsense_context))
        {
            ...
            /* Update LED status based on proximity counts */
            update_led_state(CY_CAPSENSE_PROXIMITY0_SNS0_DIFF0_VALUE);
